define(function(require, exports, module){
    ...
    var yxMobileSlider = function(settings){
        var defaultSettings = {
            width: 640, //容器宽度
            height: 320, //容器高度
            during: 5000, //间隔时间
        ...
        // return this.each(function(){
            ...
            $("div", oFocusContainer).width(oFocus.outerWidth(true) * num).css({
                ...
                marginLeft: (-oFocus.outerWidth(true)+10) * num/ 2
            });
            oFocus.first().addClass("current");
            //页面加载或发生改变
            $(window).bind('resize load', repaint);
            ...
            function doMove(){
                ...
                if(iCurr==0){
                    _this.find("ul").css("left",moveWidth);
                    // _this.find("ul").append(_this.find("li").slice(0,_this.find("li").length-2));
                    _this.find("ul li:last").css({"position":"absolute","left":-moveWidth});
                    doAnimate(0);
                }
                else{
            ...
            function doAnimate(iTarget, fn){
                oMover.stop().animate({
                    ...
                    if (fn) 
                        fn();
                        _this.find("ul li:last").css({"position":"initial"});
                });
            }
            //判断是否是移动设备
            function isMobile(){
    ...
    $.fn.yxMobileSlider = yxMobileSlider;
    module.exports=yxMobileSlider;
});
